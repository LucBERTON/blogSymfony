...
use Gedmo\Mapping\Annotation as Gedmo; //pour la génération du slug
use Symfony\Component\HttpFoundation\File\File; //pour la gestion des fichiers
use Vich\UploaderBundle\Mapping\Annotation as Vich; //pour l'upload des fichiers
